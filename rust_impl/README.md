...
Download the latest release from the [**GitHub Releases page**](RELEASES_URL).
...
| **Row format**      | Rows contain 5 or 6 fields (most stay consistent with all rows).                                                     |
...
```text
/data/sample_with_header.txt
/data/sample_no_header.txt
```
